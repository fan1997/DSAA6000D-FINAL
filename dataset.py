...
#Ruibo
        f = open(path+".smtx", "w")
        f.write(str(int(self.num_nodes)))
        f.write(",")
        f.write(str(int(self.num_nodes)))
        f.write(",")
        f.write(str(int(self.num_edges)))
        f.write("\n")
        for i in scipy_csr.indptr:
            f.write(str(int(i)))
            f.write(" ")
        f.write("\n")
        for i in scipy_csr.indices:
            f.write(str(int(i)))
            f.write(" ")           
#####
    ...
    def init_embedding(self, dim):
        ...
        self.x = torch.rand(self.num_nodes, dim).cuda()
